...
class TransactionModel:
    ...
    def get_by_account(id_compte):
        """
        Récupérer toutes les transactions d'un compte avec les informations de catégorie
        
        Args:
            id_compte (int): ID du compte
            
        Returns:
            list: Liste de dictionnaires contenant les transactions avec les infos de catégorie
        """
        conn = get_connection()
        cursor = conn.cursor()
        cursor.execute('''
        ...
        for row in rows:
            transactions.append({
                ...
                'date_modification': row[8],
                'nom_categorie': row[9],
                'icone_categorie': row[10],
                'couleur_categorie': row[11]
            })
        return transactions
    ...
    @staticmethod
    def delete_by_account(id_compte):
        """
        Supprimer toutes les transactions pour un compte
        ...
        cursor.execute('DELETE FROM "Transaction" WHERE id_compte = ?', (id_compte,))
    ...
    @staticmethod
    def delete_by_type(id_compte, type_transaction):
        """
        Supprimer toutes les transactions d'un type pour un compte
        
        Args:
            id_compte (int): ID du compte
            type_transaction (str): Type de transaction ('ENTREE' ou 'SORTIE')
        ...
        cursor.execute('DELETE FROM "Transaction" WHERE id_compte = ? AND type_transaction = ?', 
                      (id_compte, type_transaction))
